...
interface BreadcrumbLevel {
  ...
  label: string
  /** Root-relative URL pointing to the level's index page, e.g. `1066/index.html` or `1066/3-fall/index.html`. */
...
interface EventPageViewModel {
  ...
  /**
   * Root-relative URL of the bundled illustration, e.g. `1066/3-fall/battle-of-hastings/illustration.png`;
